...
const Banner = () => {
    return (
        <div style={{backgroundImage:`url(${'https://img.freepik.com/free-vector/ombre-blue-curve-light-blue-background_53876-173299.jpg'})`,height:"610px" ,backgroundRepeat:"no-repeat",backgroundSize:"cover"}} className="mb-36">
